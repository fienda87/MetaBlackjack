...
-- CreateIndex
CREATE INDEX "games_playerId_createdAt_idx" ON "games"("playerId", "createdAt" DESC NULLS LAST);
...
-- CreateIndex
CREATE INDEX "game_moves_gameId_timestamp_idx" ON "game_moves"("gameId", "timestamp" DESC NULLS LAST);
...
-- CreateIndex
CREATE INDEX "audit_logs_userId_timestamp_idx" ON "audit_logs"("userId", "timestamp" DESC NULLS LAST);
...
-- CreateIndex
CREATE INDEX "transactions_userId_createdAt_idx" ON "transactions"("userId", "createdAt" DESC NULLS LAST);

-- CreateIndex
CREATE INDEX "transactions_userId_type_createdAt_idx" ON "transactions"("userId", "type", "createdAt");
